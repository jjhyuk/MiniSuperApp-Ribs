    ...
    override func didBecomeActive() {
        ...
        dependency.superPayBalance
            ...
            .sink { [weak self] balance in
                if let balaceText = Formatter.balanceFormatter.string(from: NSNumber(value: balance)) {
                    self?.presenter.setSuperPayBalance(balaceText)
                }
            }
